...
class Wechat
{
	...
	public function __construct($options = array())
	{
        $options = array_merge(array(
            ...
            'encodingaeskey' => C('WECHAT_ENCODING') ? : '',
            'debug'     => false,
            'logcallback'    => false,
        ), $options);
...
//		return true;
	...
	public function resetJsTicket($appid=''){
		if (!$appid) $appid = $this->appid;
		$this->jsapi_ticket = '';
		$authname = 'wechat:jsapi_ticket:'.$appid;
		//$authname = 'wechat:jsticket';
		$this->removeCache($authname);
		return true;
	}
	...
	public function getJsTicket($appid='',$jsapi_ticket=''){
		...
		if ($result)
		{
            ...
            //$this->setCache($authname,[
            //    'jsticket'    => $this->jsapi_ticket,
            //    'timestamp' => (time() + $expire) * 1000
            //]); 
			return $this->jsapi_ticket;
		}
		return false;
